...
export function DashboardClient() {
    ...
    const handleExport = () => {
        ...
        const csvRows = filteredSubmissions.map(sub => {
            ...
            // Furniture counts (safely accessing dynamic data)
            const dData = sub.dynamicData?.furniture || {};
            const cja03 = dData.f_furn_cja03 || 0;
            const cja04 = dData.f_furn_cja04 || 0;
            const cja05 = dData.f_furn_cja05 || 0;
            const cja06 = dData.f_furn_cja06 || 0;
            const univ = dData.f_furn_univ || 0;
            const armchair = dData.f_furn_armchair || 0;
            const damaged = dData.f_furn_damaged || 0;
            const accessible = dData.f_furn_accessible || 0;
